...
// create a function that adds all data from the games array to the pageß
function addGamesToPage(games) {

    // loop over each item in the data
    for (let i = 0; i < games.length; i++){
        const game = games[i]; // gives me access to the current game object
...
// find the total amount pledged using the reduce function 
...
//set the inner HTML to display total number of games
...
function filterUnfundedOnly() {
    ...
    //add console log for the first key 
...
function filterFundedOnly() {
    ...
    //add console log for the second key 
...
// set the display content of the paragraph to dispay string
descriptionElement.textContent = displayStr;

// append paragraph to description container 
...
//Customization features for challange # 7: 
...
searchbtn.addEventListener("click", () => {
    ...
    if (filteredGames.length === 0){
        console.log("No games match the search query.");
        console.log(GAMES_JSON[0].name);   
        console.log(GAMES_JSON[0]);          
    }
